import { Shield, FileText, TrendingUp, Droplets, ArrowRight, FolderOpen, ClipboardCheck, BookUser, Building2, BarChart3, ListTodo, LineChart, Bot } from 'lucide-react'
    ...
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <Link href="/credit-risk" className="group block bg-white rounded-xl border border-gray-100 p-4 shadow-sm hover:shadow-md transition-all">
          ...
          <p className="text-[11px] text-gray-400 mb-2">AI-заключения по SME заёмщикам</p>
          <div className="flex flex-wrap gap-1">
            {['Заключения SME','Заёмщики','Стресс-тест'].map(t => (
