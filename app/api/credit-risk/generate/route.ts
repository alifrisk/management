...
Если есть расхождения — отметь их как замечания в разделе [ХАРАКТЕРИСТИКА ЗАЁМЩИКА].
...
2-3 предложения: сектор бизнеса, опыт (${fd.years_in_business || '?'} лет), кредитная история, общая оценка надёжности клиента. Если есть расхождения в балансе — кратко отметь.
