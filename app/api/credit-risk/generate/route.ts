...
СТРОГО ЗАПРЕЩЕНО: упоминать баланс, ОПУ, ОДДС, финансовую отчётность, «отчётность не предоставлена», «финансовые данные отсутствуют», «баланс/ОПУ/ОДДС не представлены» или любые подобные фразы. Если коэффициент показывает «н/д» — просто не анализируй этот показатель, не комментируй его отсутствие.
