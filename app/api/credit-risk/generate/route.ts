...
Составь профессиональное заключение строго по структуре:

1. ОБЩАЯ ХАРАКТЕРИСТИКА ЗАЁМЩИКА
(Краткое описание бизнеса, опыт, кредитная история)

2. АНАЛИЗ ФИНАНСОВОГО ПОЛОЖЕНИЯ (БАЛАНС)
(Динамика активов, обязательств, капитала между периодами. Рассчитай: долговая нагрузка = обязательства/активы, коэффициент покрытия)

3. АНАЛИЗ ФИНАНСОВЫХ РЕЗУЛЬТАТОВ (ОПУ)
(Динамика выручки, рентабельность = прибыль/выручка, тренд)

4. АНАЛИЗ ДЕНЕЖНЫХ ПОТОКОВ (ОДДС)
(Операционный поток, способность обслуживать долг)

5. ОЦЕНКА ОБЕСПЕЧЕНИЯ
(Залоги, достаточность покрытия = залог/кредит)

6. ОСНОВНЫЕ РИСКИ И ЗАКЛЮЧЕНИЕ
(Ключевые риски, итоговый вывод)
