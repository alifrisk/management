...
ПРАВИЛА:
- Коэффициенты (КТЛ, КБЛ, Кфин): число как есть: 1.80, 0.35
- Проценты (ROA, ROE): число БЕЗ знака %: 8.1 (не "8.1%")
- Денежные суммы (выручка, прибыль, поток): только цифры без разделителей: 1234567
- "—", "-", "н/д", пусто → null
