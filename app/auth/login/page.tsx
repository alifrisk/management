      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 animate-fade-in">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Используйте корпоративную почту Алиф Банк
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm text-[#1B8A4C] hover:text-[#177040] font-medium transition-colors"
              >
                Забыли пароль?
              </Link>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-[#1B8A4C] hover:bg-[#177040] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link
                href="/auth/register"
                className="text-[#1B8A4C] hover:text-[#177040] font-medium transition-colors"
              >
                Зарегистрироваться
              </Link>
            </p>
