...
═══ ОПУ (USD) ═══
Чистый процентный доход: ${f(d.p1_nim)} → ${f(d.p2_nim)}${trend(d.p1_nim, d.p2_nim)}
Операционный доход:      ${f(d.p1_op_income)} → ${f(d.p2_op_income)}${trend(d.p1_op_income, d.p2_op_income)}
Резервы:                 ${f(d.p1_provisions)} → ${f(d.p2_provisions)}${trend(d.p1_provisions, d.p2_provisions)}
...
2. АНАЛИЗ ДОХОДНОСТИ
Оцени NIM, операционный доход, чистую прибыль. Тренды и причины изменений. 2-3 предложения.
